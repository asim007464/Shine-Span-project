      ...
      <section className="relative py-20 bg-[#0f1216] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            We're more than just a cleaning service – we're your trusted partner
            in creating a clean, healthy, and comfortable environment for your
            home and business.
          </p>
        </div>
      </section>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6 text-gray-500 text-[17px] leading-relaxed">
                ...
                <p>
                  ...
                  innovate our services, finding new ways to enhance quality and
                  efficiency. In doing so, we aim to build lasting trust with
                  our clients and create cleaner, healthier spaces for our
